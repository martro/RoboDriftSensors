...
\rfoot{} 
\begin{document}
\begin{table}[h]\begin{tabular}{lll}\begin{Huge}Drużyna\end{Huge}          & \multicolumn{2}{l}{\textbf{\begin{Huge}Kabaczki\end{Huge}}} \\\begin{Huge}Członkowie:\end{Huge}        &       &              \\\multirow{2}{*}{} & 1     &Michał Szlachetka \\&2&MIchał Junior \\\end{tabular}\end{table}\begin{table}[h]\begin{tabular}{|l|l|l|l|}
\hline
